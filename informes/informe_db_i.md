...
CREATE TABLE Persona (
    ...
    CONSTRAINT chk_anio_minimo CHECK (YEAR(fecha_nacimiento) > 1900)
);
```
...
WHERE per.fecha_nacimiento > '1980-01-01';
```
...
-->
<!-- TODO (ADJUNTAR CAPTURAS)
#### C. Evidencias de IA [`CHAT IA`](../anexos/chat_ia_dbi.pdf)
