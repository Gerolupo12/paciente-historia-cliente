...
-- =====================================================================
-- Prompt utilizado:
-- "Ejecutamos una transacción simple que primero lee el nombre de un paciente de la tabla
-- paciente, luego hacemos una pausa de 5 segundos, y al volver a leer el nombre, encontramos 
-- que ha cambiado. La base de datos está en READ COMMITTED. ¿Qué significa que el dato cambie 
-- dentro de mi transacción y cómo lo evito usando un nivel de aislamiento?"

-- Respuesta resumida:
-- "Sugerencia (Paso Adicional Simple): Para evitar que el dato cambie dentro de su transacción,
--  debe usar un nivel de aislamiento más estricto que mantenga una "instantánea" (snapshot) de
-- los datos que lee."
--
-- Reflexión:
-- "La sugerencia me ayudó a entender cómo usar REPEATABLE READ, se evita que los datos que 
-- ya se han leído cambien, forzando la consistencia hasta que confirme o revierta la transacción."
-- =====================================================================
