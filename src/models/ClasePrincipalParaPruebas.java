...
public class ClasePrincipalParaPruebas {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("¿Puede O- donar a AB+? -> " + GrupoSanguineo.O_MINUS.puedeDonarA(GrupoSanguineo.AB_PLUS));
        System.out.println("¿Puede A+ donar a O-? -> " + GrupoSanguineo.A_PLUS.puedeDonarA(GrupoSanguineo.O_MINUS));
