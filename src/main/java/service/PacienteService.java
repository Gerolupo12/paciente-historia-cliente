 ...
 * <li>Si alguna operación falla, se revierte todo (atomicidad
 * garantizada).</li>
 * </ul>
 * </p>
 *
...
public class PacienteService implements GenericService<Paciente> {
     ...
     * <li>Delete (RN-013): Eliminar la HC asociada <b>antes</b> de eliminar el
     * Paciente.</li>
     * <li>Recover (RN-031): Recuperar la HC asociada <b>antes</b> de recuperar el
     * Paciente.</li>
     * </ul>
     */
